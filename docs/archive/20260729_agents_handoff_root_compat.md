...
> **Archive status as of 2026-07-29**
> - 原始创建：2026-07-29
> - 完成/验收：2026-07-29
> - 归档：2026-07-29
> - 当前正式入口：`README.md`、`README.zh-CN.md`、`docs/agent_conventions.md`
...
Implementation, formal review, native-host installation, browser reload, and
Codex token refresh complete.
